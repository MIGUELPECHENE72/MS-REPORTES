...
@Repository
public class DynamoDBTemplateAdapter extends TemplateAdapterOperations<ReporteSolicitud, String, ModelEntity> implements ReporteSolicitudRepository {
    ...
    public DynamoDBTemplateAdapter(DynamoDbEnhancedAsyncClient connectionFactory, ObjectMapper mapper) {
         ...
         */
        super(connectionFactory, mapper, d -> mapper.map(d, ReporteSolicitud.class ), "reporte_solicitud");
    }
